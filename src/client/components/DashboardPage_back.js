...
export default class DashboardPage extends Component{
  ...
  sortTitle = ()=>{
    const sortedEmployee = this.state.employees.sort((a, b) => {
      let num;
      if(this.state.isSortAsc === false){ //Sort ascending order
        num = (a.job_titles < b.job_titles ? -1: 1);
      }
      if(this.state.isSortAsc){ ////Sort by descending 
        num = (a.job_titles > b.job_titles ? -1: 1);
      }
      return num;
    });
  ...
  handlePageChange = (pageNumber) => {
    ...
    this.fetchEmployees.current.getEmployeeData(pageNumber);
    this.setState({
          ...
          <Col xs={12} sm={10}>
            ...
            <thead>
              <tr>
                <th>Employee ID</th>
                <th>Name</th>
                <th>Title <button onClick={this.sortTitle}>Sort</button></th>
                <th>Department</th>
              </tr>
            </thead> 
